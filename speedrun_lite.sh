...
echo ">>>> LOOK HERE FOR TORCH CHANGE"
...
python -m nanochat.dataset -n 25 &
...
torchrun --standalone --nproc_per_node=$NPROC_PER_NODE -m scripts.mid_train -- --run=$WANDB_RUN --device_batch_size=16
